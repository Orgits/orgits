...
function AboutTwo() {
	return (
		<div className="section orgits-section-padding6 overflow-hidden">
			<div className="container">
				<div className="row">
					<div className="col-lg-5 order-lg-1 offset-lg-1">
						<FadeInRight className="orgits-content-thumb ">
							<img src={Thumb2Img} alt="Thumb2Img" />
							<div className="orgits-thumb-shape2">
					...
					<div className="col-lg-6">
						<div className="orgits-default-content familjen-grotesk">
							...
							<div className="orgits-list-icon">
								<ul>
									<li>
