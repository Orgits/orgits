...
function ServiceCard({ service: { title, description }, index }) {
	return (
		<div className="orgits-service7-wrap">
			<div className="orgits-service7-title">
				<h3>{`${index + 1}. ${title}:`}</h3>
			</div>
			<div className="orgits-service7-description">
				<p>{description}</p>
			</div>
			<Link className="orgits-service7-btn" to="/single-service">
