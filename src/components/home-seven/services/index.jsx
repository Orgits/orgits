...
function Services() {
	return (
		<div className="section dark-bg3 orgits-section-padding5">
			<div className="container">
				<div className="orgits-section-title light bricolage-font">
					<div className="row">
						...
						<div className="col-lg-5 d-flex align-items-center justify-content-end">
							<div className="orgits-title-btn">
								<Link className="orgits-default-btn blue-btn2" to="/service">
									<span className="orgits-label-up">View All Services</span>
									<span className="orgits-label-up">View All Services</span>
								</Link>
							</div>
						</div>
