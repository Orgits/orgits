...
const appDevSchema = {
    ...
    description: 'We design and develop business applications that connect user needs with practical business objectives. From customer-facing mobile applications to internal business systems, our approach focuses on usability, scalability, security and maintainability.',
...
const breadcrumbSchema = {
    ...
    itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'Mobile & Web App Development', item: `${siteUrl}/app-development` },
    ],
}

export const metadata = {
    title: 'Mobile & Web App Development | Orgits Business Solutions',
    description: 'We design and develop scalable web and mobile applications using modern technologies for business, customer and operational use cases. From business requirements to production.',
    keywords: 'mobile app development, web application development, custom app development, business app development, React Native, Flutter, Node.js',
    openGraph: {
        title: 'Mobile & Web App Development | Orgits Business Solutions',
        description: 'We design and develop scalable web and mobile applications using modern technologies for business, customer and operational use cases.',
        url: `${siteUrl}/app-development`,
        type: 'website',
        images: [
            {
                url: `${siteUrl}/assets/img/og-app-dev.jpg`,
                width: 1200,
                height: 630,
                alt: 'Mobile & Web App Development Services',
            },
        ],
    },
    twitter: {
        ...
        title: 'Mobile & Web App Development | Orgits Business Solutions',
        description: 'We design and develop scalable web and mobile applications using modern technologies for business, customer and operational use cases.',
        images: [`${siteUrl}/assets/img/og-app-dev.jpg`],
    },
    alternates: {
    ...
    return (
        <>
            <Script
                ...
                dangerouslySetInnerHTML={{ __html: JSON.stringify([appDevSchema, breadcrumbSchema]) }}
            />
            <Layout headerStyle={4} footerStyle={1} breadcrumbTitle="Mobile & Web App Development">
            {/*Start Service Details*/}
            <section className="service-details" aria-labelledby="app-dev-heading">
...
<div className="content-box">
                                         <h1 id="app-dev-heading">Mobile & Web App Development</h1>
                                        <p>
